...
from algaware.core.boolean_base import StatBooleanBase
from algaware.readers.txt_reader import load_txt
from algaware.core.interpolate import get_interpolated_df
...
class StatisticsHandler(StatBooleanBase):
    ...
    def __init__(self, statpath=''):
        super().__init__()
        self.data = load_txt(statpath, as_dtype=False, fill_nan=np.nan)
